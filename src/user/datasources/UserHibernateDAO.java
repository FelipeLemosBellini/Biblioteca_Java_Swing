...
public class UserHibernateDAO implements IUserRepository {

    IPersistentDataRepository persistentDataRepository;

    public UserHibernateDAO(IPersistentDataRepository persistentDataRepository) {
...
//        SeedList();
    ...
    @Override
    public UserEntity getUser(String loginSearch) {
        UserEntity userEntity = null;
        try {
            userEntity = persistentDataRepository.getDatabaseSessionFactory().fromTransaction(session -> {
