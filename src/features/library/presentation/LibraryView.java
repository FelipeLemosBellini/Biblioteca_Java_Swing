...
public class LibraryView extends JFrame implements IBookListener {
    ...
    private void openSaveScreen(ActionEvent event) {
        try {
            ...
            BookEntity bookEntity = _libraryController.getBook(id);
            _libraryController.openBookEdit(bookEntity);
...
//            _libraryController.deleteBook(bookEntity);
    ...
    private void borrow(ActionEvent event) {
        try {
            int id = getBookIdFromTable();
            BookEntity bookEntity = _libraryController.getBook(id);
            _libraryController.openBookLending(bookEntity);
        } catch (NotSelectedRowException e) {
    ...
    private void updateTable() {
        ...
        List<BookEntity> booksList = _libraryController.getBook(searchString);
